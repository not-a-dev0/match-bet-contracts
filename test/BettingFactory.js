...
contract('BettingFactory', (accounts) => {
    ...
    beforeEach(async () => {
        ...
        assert.equal(web3.toUtf8(PLAYER_HULK_HOGAN_NAME), "Hulk Hogan", "Player name should be Hulk Hogan");
        ...
        assert.equal(web3.toUtf8(PLAYER_JOHN_CENA_NAME), "John Cena", "Player name should be John Cena");
        ...
        assert.equal(web3.toUtf8(PLAYER_JAKE_THE_SNAKE_NAME), "Jake The Snake", "Player name should be Jake The Snake");
        ...
        assert.equal(web3.toUtf8(PLAYER_THE_UNDERTAKER_NAME), "The Undertaker", "Player name should be The Undertaker");
    ...
    it("should able to create Matches", async () => { 
        await bettingFactory.createMatch("Hulk Hogan vs. John Cena", PLAYER_HULK_HOGAN_ADDR, PLAYER_JOHN_CENA_ADDR, {from: owner});
        await bettingFactory.createMatch("Jake The Snake vs. The Undertaker", PLAYER_JAKE_THE_SNAKE_ADDR, PLAYER_THE_UNDERTAKER_ADDR, {from: owner});
        await bettingFactory.createMatch("Hulk Hogan vs. The Undertaker", PLAYER_HULK_HOGAN_ADDR, PLAYER_THE_UNDERTAKER_ADDR, {from: owner});
        await bettingFactory.createMatch("John Cena vs. Jake The Snake", PLAYER_JOHN_CENA_ADDR, PLAYER_JAKE_THE_SNAKE_ADDR, {from: owner});
        ...
        assert.equal(web3.toUtf8 (match_1[MATCH_DESCRIPTION]), "Hulk Hogan vs. John Cena", "Description should be 'Hulk Hogan vs. John Cena'");
        ...
        assert.equal(web3.toUtf8 (match_2[MATCH_DESCRIPTION]), "John Cena vs. Jake The Snake", "Description should be 'John Cena vs. Jake The Snake'");
    ...
    it("should be able to create match betting.", async () => { 
        await bettingFactory.createMatch("Hulk Hogan vs. John Cena", PLAYER_HULK_HOGAN_ADDR, PLAYER_JOHN_CENA_ADDR);  
        const matches = await bettingFactory.getMatches();
        ...
        // assert.equal(web3.toUtf8 (match_1[DESCRIPTN_FLD]), "Hulk Hogan vs. John Cena", "Description should be 'Hulk Hogan vs. John Cena'");
        ...
        assert.equal(web3.toUtf8(betting[2]), "Hulk Hogan vs. John Cena", "Match description should be 'Hulk Hogan vs. John Cena'");
